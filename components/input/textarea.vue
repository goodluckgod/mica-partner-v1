<template>
  <div class="relative h-full">
    <textarea
      ...
      ref="input"
      autocomplete="off"
      class="block h-full scrollbar px-2.5 pb-2.5 pt-6 w-full focus:outline-2 outline-black text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-300 appearance-none focus:ring-0 peer"
      placeholder=" "
      :type="type ? type : 'text'"
      @input="input"
